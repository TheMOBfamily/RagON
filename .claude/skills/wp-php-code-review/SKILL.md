...
```
READ /home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/99-quick-reference.md
READ /home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/02-enhanced-validation-checklist/00-validation-checklist-overview.md
READ /home/fong/Projects/de/wp/.deutschfuns/docs/instructions-jsdoc-codestyle/99-quick-reference.md
READ /home/fong/Projects/de/wp/.deutschfuns/docs/instructions-css-codestyle.md (Quick Checklist section)
READ /home/fong/Projects/de/wp/.deutschfuns/docs/instructions-html-dom-BEM-codestyle.md (Quick Checklist section)
```
...
**Source:** `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/99-quick-reference.md`
...
**Source:** `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-jsdoc-codestyle/99-quick-reference.md`
...
**Source:** `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-css-codestyle.md`
...
**Source:** `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-html-dom-BEM-codestyle.md`
...
**Default folder:** `/home/fong/Projects/de/wp/.fong/docs/code-reviews/`
...
# 4. Output Format:
- File: REVIEW-{date}_{scope}.md in /home/fong/Projects/de/wp/.fong/docs/code-reviews/
...
```
Read tool -> /home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/99-quick-reference.md
Read tool -> /home/fong/Projects/de/wp/.deutschfuns/docs/instructions-jsdoc-codestyle/99-quick-reference.md
Read tool -> /home/fong/Projects/de/wp/.deutschfuns/docs/instructions-css-codestyle.md (Quick Checklist)
Read tool -> /home/fong/Projects/de/wp/.deutschfuns/docs/instructions-html-dom-BEM-codestyle.md (Quick Checklist)
```
...
9. **Write report** -> Save to `/home/fong/Projects/de/wp/.fong/docs/code-reviews/`
...
- [ ] Report saved to `/home/fong/Projects/de/wp/.fong/docs/code-reviews/`?
...
| Context | File |
|---------|------|
| **PHP Codestyle Index** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/00-instructions-phpdoc-codestyle-deutschfuns-pattern.md` |
| **PHP Quick Reference** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/99-quick-reference.md` |
| **PHP Validation Checklist** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/02-enhanced-validation-checklist/` |
| **PHP Validation Tools** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/04-validation-tools-automation/` |
| **JS Codestyle Index** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-jsdoc-codestyle/00-instructions-jsdoc-codestyle.md` |
| **JS Quick Reference** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-jsdoc-codestyle/99-quick-reference.md` |
| **CSS Codestyle** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-css-codestyle.md` |
| **HTML/BEM Codestyle** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-html-dom-BEM-codestyle.md` |
| **Refactor Check** | `/home/fong/Projects/de/wp/.deutschfuns/docs/refactoring/refactor-check-DRY-SSoT-SOLID-SRP.md` |
| **Code Review Examples** | `/home/fong/Projects/de/wp/.fong/docs/code-reviews/` |
| **File Naming Conventions** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/17-file-naming-conventions.md` |
| **Time Architecture** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/29-time-architecture.md` |
| **Module V3 Template** | `/home/fong/Projects/de/wp/.deutschfuns/docs/instructions-phpdoc-codestyle-deutschfuns-pattern/05-standard-module-v3-template/` |
