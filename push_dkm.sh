...
SOURCE_PROJECT="/home/fong/Projects/mini-rag"
...
# Searching in /home/fong/Projects with maxdepth 3 to catch nested projects
TARGETS=$(find /home/fong/Projects -mindepth 2 -maxdepth 3 -name ".fong" -type d 2>/dev/null | sort -u)
